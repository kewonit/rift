...
- Added the free non-filtering source workflow and unsigned arm64 app, extension,
  and CLI product verification.
- Added explicit fail-open recovery behavior, configuration/history corruption
  preservation, bounded persistence, XPC authorization/timeouts, and release
  documentation.

The signed Network Extension, clean-machine, soak, fault-injection, and
notarization gates remain open. This section is not a release announcement.
