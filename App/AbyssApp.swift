...
@main
struct AbyssApp: App {
    @NSApplicationDelegateAdaptor(AbyssApplicationDelegate.self)
    private var applicationDelegate
    private let startup = AppStartupCoordinator.shared

    var body: some Scene {
        Window("Abyss", id: "main") {
...
@MainActor
private final class AbyssApplicationDelegate: NSObject, NSApplicationDelegate {
